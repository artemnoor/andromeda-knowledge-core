"""Remove ingestion-only persistence from Knowledge Core."""

import sqlalchemy as sa
from alembic import op
from sqlalchemy.dialects import postgresql

revision = "0006_remove_ingestion_pipeline"
down_revision = "0005_ingestion_pipeline"
branch_labels = None
depends_on = None
...
def _create_ingestion_pipeline_table() -> None:
    op.create_table(
...
def downgrade() -> None:
    _create_ingestion_pipeline_table()
